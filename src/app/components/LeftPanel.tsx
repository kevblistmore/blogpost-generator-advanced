              ...
              {isLoading ? (
                ...
                <ul className="list-disc mt-2 pl-5">
                  {suggestions.map((sug, index) => (
                    <li key={index} className="cursor-pointer hover:underline" onClick={() => applySuggestion(sug)}>
                      {sug}
                      {/* Optionally, add an inline expand to preview suggestion details */}
                    </li>
                  ))}
                </ul>
              ) : (
